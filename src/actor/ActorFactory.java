...
public final class ActorFactory {
	...
	public enum Type {
		HOBBIT()	{ @Override public Actor create(Army armyAllegiance) { return new Hobbit(armyAllegiance); } },
		TROLL()	{ @Override public Actor create(Army armyAllegiance) { return new Troll(armyAllegiance); } },// HOBBIT is a constant, thus all UPPERCASE letters
